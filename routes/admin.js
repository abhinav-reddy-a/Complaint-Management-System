...
router.get('/home',(req,res)=>{
	...
	db.query(query, function (err, result, fields) {
		checkError(err,res);
		console.log(result);
		res.render('home.ejs',{result:result,name:req.user.name,role:'admin'});	
	});	
})
...
router.get('/history',(req,res)=>{
	...
	db.query(query, function (err, result, fields) {
		checkError(err,res);
		console.log(result);
		res.render('history.ejs',{result:result,name:req.user.name,role:'admin'});	
	});	
})
...
router.get('/complaint',(req,res)=>{
	...
	db.query(query, function (err, result, fields) {
		checkError(err,res);
		console.log(result);
		res.render('complaint.ejs',{result:result,role:'admin',name:req.user.name});
	});	
})
